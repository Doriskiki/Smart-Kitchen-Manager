...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"2px solid #dbd9f4","padding":"10px","margin":"10px 0 0 0","alignItems":"center","borderRadius":"8px","flexWrap":"wrap","background":"#f8f8fc","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>烹饪方式</div>
        <el-input v-model="formSearch.pengrenfangshi" placeholder="烹饪方式" clearable></el-input>
      </el-form-item>
		...
		<div class="list2 index-pv1" :style='{"width":"100%","padding":"20px 32px 20px 20px","flexWrap":"wrap","justifyContent":"space-between","display":"block","height":"auto"}'>
			<div :style='{"cursor":"pointer","padding":"0","margin":"0 0 20px 2%","borderRadius":"8px","background":"#f6f6f6","display":"inline-block","width":"23%","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				...
				<div class="item-info" :style='{"padding":"0px","overflow":"hidden","borderRadius":"0 0 8px 8px","background":"#f6f6f6","display":"inline-block","width":"100%","height":"auto"}'>
					<div :style='{"padding":"0 0 0 12px","margin":"0px 24px 4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"0 20px 20px 0","background":"#ede9f6","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.caipumingcheng}}</div>
					<div :style='{"padding":"0 0 0 12px","margin":"0px 24px 4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"0 20px 20px 0","background":"#ede9f6","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.caishileixing}}</div>
					<div :style='{"padding":"0 0 0 12px","margin":"0px 24px 4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderRadius":"0 20px 20px 0","background":"#ede9f6","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">分数:{{item.fenshu}}</div>
	...
	<div class="hot" :style='{"border":"2px solid #dbd9f4","margin":"20px 0 0","borderRadius":"8px","background":"#fff","width":"100%","position":"relative","height":"auto"}'>
	  ...
	  <div :style='{"padding":"20px","margin":"4px 0 0 0","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="(item, index) in hotList" :key="item.id || index" :style='{"cursor":"pointer","width":"23%","padding":"0 0 8px 0","borderRadius":"8px","background":"#f6f6f6","height":"auto"}' @click="toDetail(item)">
	      ...
	      <div :style='{"padding":"0 0 0 12px","margin":"0px 24px 4px 0","color":"#333","borderRadius":"0 20px 20px 0","background":"#ede9f6","lineHeight":"32px","fontSize":"14px"}'>{{item.caishileixing}}</div>
	      <div :style='{"padding":"0 0 0 12px","margin":"0px 24px 4px 0","color":"#333","borderRadius":"0 20px 20px 0","background":"#ede9f6","lineHeight":"32px","fontSize":"14px"}'>{{item.fenshu}}</div>
